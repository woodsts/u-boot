...
static void mxs_batt_boot(void)
{
	...
	if (IS_ENABLED(CONFIG_MXS_PMU_MINIMAL_VDD5V_CURRENT))
		setbits_le32(&power_regs->hw_power_5vctrl,
			     POWER_5VCTRL_ILIMIT_EQ_ZERO);

	if (IS_ENABLED(CONFIG_MXS_PMU_DISABLE_BATT_CHARGE)) {
	...
	if (IS_ENABLED(CONFIG_MXS_PMU_ENABLE_4P2_LINEAR_REGULATOR))
		mxs_power_enable_4p2();
}
