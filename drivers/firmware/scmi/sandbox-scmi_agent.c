...
static u8 protocols[] = {
	IS_ENABLED(CONFIG_SCMI_POWER_DOMAIN, (SCMI_PROTOCOL_ID_POWER_DOMAIN,))
	IS_ENABLED(CONFIG_CLK_SCMI, (SCMI_PROTOCOL_ID_CLOCK,))
	IS_ENABLED(CONFIG_RESET_SCMI, (SCMI_PROTOCOL_ID_RESET_DOMAIN,))
	IS_ENABLED(CONFIG_DM_REGULATOR_SCMI, (SCMI_PROTOCOL_ID_VOLTAGE_DOMAIN,))
};
