...
the file. The change to CONFIG_PPL_TEXT_BASE is also an offset of 0x100 bytes
...
Change::
   ...
   #define CONFIG_PPL_TEXT_BASE		0x00100000

to::

   #define CONFIG_PPL_TEXT_BASE		0x02000100
...
(see above) must start at the same address as U-Boot's CONFIG_PPL_TEXT_BASE.
