...
#endif
#if IS_ENABLED(CONFIG_SHA256_SMALLER)
...
#endif
#if IS_ENABLED(CONFIG_SHA512_SMALLER)
...
#if IS_ENABLED(CONFIG_X509_CERTIFICATE_PARSER)
#define MBEDTLS_X509_USE_C
#define MBEDTLS_X509_CRT_PARSE_C
#define MBEDTLS_X509_CRL_PARSE_C
#endif

#if IS_ENABLED(CONFIG_ASYMMETRIC_PUBLIC_KEY_SUBTYPE)
#define MBEDTLS_PK_C
#define MBEDTLS_PK_PARSE_C
#endif

#if IS_ENABLED(CONFIG_RSA_PUBLIC_KEY_PARSER)
...
#if IS_ENABLED(CONFIG_ASN1_DECODER)
